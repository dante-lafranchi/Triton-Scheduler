...
function Seminar({ section, courseOverview }) {
    ...
    return (
        ...
        >
            <label className='seminar-checkbox-and-label'>
                <input
                    type='checkbox'
                    checked={isChecked}
                    id={`seminar-checkbox-${section.uniqueIdentifier}`}
                    onChange={() => {
                ...
                <div className='checkbox-label'>{section.SECT_CODE}</div>
            </label>
            <div className='seminar-details-body'>
                <div
                ...
                >
                    ...
                    {section.professor !== 'Staff' && (
                        <div className='professor-arrow-icon'>
                            <svg
                ...
                >
                    {section.professor !== 'Staff' && (
                        <ProfessorRatings subAndCrseCode={section.subAndCrseCode} professorName={section.professor} />
                    )}
                </div>
                <span>
                    {' '}
                ...
                <p className={section.enrollmentColorClass + ' seminar-enrolled-info'}>
